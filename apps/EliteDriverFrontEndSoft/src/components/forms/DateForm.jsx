...
const DateForm = ({ variant = 'default', onSearch }) => {
  ...
  // 🔒 Bloquear escritura / pegado (solo usar calendario)
  ...
  // Variante home / homeMobile (vertical)
  return (
    <div className={styles.container}>
      <h3 className={styles.title}>Reserva tu vehículo</h3>
